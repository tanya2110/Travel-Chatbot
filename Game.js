        ...
        switch(this.stateCur){
            ...
            case GameState.PLACE: 
                if(sInput.toLowerCase().match("england")){    
                    ...
                    sReply ="India is a famous place for tourism and is famous for a different type of tourist spots like Nature places, Architecture & Culture, Honeymoon spots, Adventure acts, Shopping, and Historical places of India"; 
                    this.stateCur=GameState.DATE;  
                }
                else{
